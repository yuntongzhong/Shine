...
public class ContactsFragment extends Fragment {
    ...
    private final ArrayList<NewsEntity> list = new ArrayList<NewsEntity>();
    ...
    public static class ResfreshHandler extends Handler {
        WeakReference<ContactsFragment> mFragmentWeakReference;

        ResfreshHandler(ContactsFragment contactsFragment) {
            mFragmentWeakReference = new WeakReference<ContactsFragment>(contactsFragment);
        }

        @Override
        public void handleMessage(Message msg) {
            ContactsFragment theFragment = mFragmentWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (headerGroup == null) {
            headerGroup = (ViewGroup) LayoutInflater.from(getContext()).inflate(R.layout.header_list_layout, container, false);
        }
